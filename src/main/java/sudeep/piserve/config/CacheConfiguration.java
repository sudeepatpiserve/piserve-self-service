...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, sudeep.piserve.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, sudeep.piserve.repository.UserRepository.USERS_BY_EMAIL_CACHE);
